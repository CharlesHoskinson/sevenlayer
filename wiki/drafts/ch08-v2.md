...
<!-- Revision ledger
P1-1 (ch08-the-price-of-a-verdict, A): Fusaka/PeerDAS DA capacity claim. Original text: "an 8x increase in DA capacity over the original EIP-4844 specification." Replaced with "roughly a 4.7x increase on target (3 → 14 blobs per block) over the original EIP-4844 specification." The 3 → 14 blob target ratio is the correct figure (14/3 ≈ 4.67); the Pectra line was also cleaned up ("Raised the blob target from 3 to 6, and the maximum from 6 to 9") removing the soft "doubled ... to approximately 9" phrasing for consistency.
P1-2 (ch08-on-chain-verification-in-2026, A): "expanded DA capacity by roughly 16x" — no arithmetic supports this. Rewrote as "expanded blob-based DA capacity from the original EIP-4844 target of 3 blobs per block to roughly 14 under Fusaka/PeerDAS — about a 4.7x increase over two years." Consistent with the price-of-a-verdict section. No 16x figure invented.
Preserved: Beanstalk $182M flash-loan narrative, Tornado Cash CREATE2 governance narrative, price-of-a-verdict gas analysis, Fiat-Shamir Frozen Heart / Last Challenge Attack / Solana ZK ElGamal treatments (canonically cited in ch06), L2Beat Stages framework, proof aggregation section, Midnight three-token / verifier-key architecture discussion, pricing attacks (DA-saturation, prover-killer), the deepest symmetry observation.
Voice edits: replaced "Let us start with money" with "Start with money"; "The critical difference" with "The decisive difference"; "the key to the trick" with "what the trick turns on"; "the critical subtlety" with "the subtlety"; "the deepest insight" with "the deepest observation"; numbered four-step Last Challenge enumeration flattened to prose; removed a "Critically," and an "it is also worth noting" hedge. All other preserved passages unchanged.
Length: ~6,840 words (source ~6,900). Within ±15%.
Items resolved: 2/2.
-->
