...
<!-- Revision ledger
v2 fixes (inherited):
P0-1 (Jolt Layer 1): Replaced "Trusted (Hyrax/Pedersen commitments)" with "Transparent (Hyrax commitments over BN254; no trusted setup)." Trust assumption clarified.
P1-2 (Performance citations): Added [52], [53], [43/44], [55] at relevant claims. ZKPoG softened to "substantial GPU speedups." OpenVM SWIRL data retained.
P1-3 (ZisK org): SilentSig GmbH in-table with "ex-Polygon Hermez team" note and one-line footnote.
P1-4 (Stwo 100x vs 125x): Layer 5/6 paragraphs distinguish raw arithmetic (125x) from end-to-end pipeline (100x).

v3 fixes (P2, this revision):
P2-01 [ch11-performance-the-cost-collapse] (A): "45x" corrected to "~42x" ($1.69 ÷ $0.04 = 42.25x).
P2-02 [ch11-risc-v-convergence] (C): "generational outlier" replaced with "the only production zkVM still using pairing-based KZG commitments rather than hash-based FRI."
P2-03 [ch11-risc-v-convergence] (B): Gassmann et al. citation expanded to include descriptive title and preprint designation; citation key [59] added.
P2-04 [ch11-the-landscape-table-march-2026] (B): Benchmark numbers in landscape table now carry per-cell citations ([52], [53], [43], [56]). EF declaration already cited [55] in v2.
P2-05 [ch11-the-landscape-table-march-2026] (B): "62 RISC-V opcodes" rubric entry now cites [57].
P2-06 [ch11-the-landscape-table-march-2026] (D): "Neo/SuperNeo (watch)" rubric cell expanded with one-sentence gloss identifying them as research-stage systems, not yet production.
P2-07 [ch11-the-proof-core-triad] (A): SP1 triad line corrected from "multilinear PCS (Layer 6)" (used twice) to "multilinear PCS (Layer 5/6)"; Jolt line likewise corrected to "Hyrax commitment (Layer 5/6)".
P2-08 [ch11-the-stage-is-set] (D): "Philosophy C absorbed Philosophies A and B" glossed inline as "Philosophy C (general-purpose ISA) absorbed Philosophies A (EVM-compatible) and B (ZK-native ISA)."
P2-09 [ch11-the-stage-is-set] (A): "proof core from Chapter 10" corrected to "proof core first identified in Chapter 6"; second mention updated to "Chapter 6 identified and Chapter 10 revisited."
P2-10 [ch11-three-zkvms-through-seven-layers] (B): SP1 Layer 3 "60-70% of total proving time" now cites [58].
P2-11 [ch11-three-zkvms-through-seven-layers] (B): Gassmann et al. citation in Stwo distinctive section now carries [59] and is matched to the expanded citation in RISC-V Convergence.
P2-12 [ch11-zkvms-across-the-stack] (B): "Polygon zkEVM's shutdown at Layer 2" now carries "(Chapter 3)" as a forward reference to the sourced section.
P2-13 [ch11-zkvms-across-the-stack] (B): Cross-layer causal claims (Witness Gap, LogUp/CCS, etc.) now carry chapter forward references anchoring each claim to its sourced treatment.
-->
