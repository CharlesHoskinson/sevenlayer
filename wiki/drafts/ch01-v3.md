...
---
<!-- Revision ledger -->
<!-- P2 item: [ch01-the-trick] (B) — Added "originally STOC 1985, pp. 291–304" to GMR citation alongside existing SICOMP reference. -->
<!-- P2 item: [ch01-the-trick] (C) Clarke allusion — Added "Clarke's aphorism holds that sufficiently advanced technology is indistinguishable from magic." to anchor the reference for unfamiliar readers. -->
<!-- P2 item: [ch01-the-trick] (C) Three-beat aphorism — Collapsed "To prove is to show. To show is to reveal. To reveal is to lose control." into a single semicolon-joined sentence. -->
<!-- P2 item: [ch01-the-proof-at-the-door] (B) — Added "an assumption the GMR paper itself set out to overturn" to anchor the claim to the existing citation. -->
<!-- P2 item: [ch01-the-proof-at-the-door] (C) — "The sun will burn out first" retained here; P2 notes it appears in a Key claims block elsewhere in the document — that block is outside Chapter 1's scope (lines 147–385) so no change needed in this draft. -->
<!-- P2 item: [ch01-the-proof-at-the-door] (E) — Added knowledge-soundness note: "A stronger variant, knowledge-soundness, asks not just that cheaters fail but that any convincing prover must actually know the secret -- which is where the 'K' in SNARK comes from, and a distinction Chapter 5 will sharpen." -->
<!-- P2 item: [ch01-the-phenomenon] (A) — Replaced "three points on an elliptic curve — three pairs of coordinates" with accurate G1/G2 description: two G1 points (48 bytes each) and one G2 point (96 bytes) on BLS12-381. Total 192 bytes preserved. -->
<!-- P2 item: [ch01-the-phenomenon] (C) — "Smaller than a tweet" → "Smaller than a short tweet". -->
<!-- P2 item: [ch01-the-phenomenon] (C) — Prescription scenario condensed from four paragraphs to two sentences integrated into the existing pattern paragraph; removed redundant analytical content. -->
<!-- P2 item: [ch01-three-converging-forces] (A) — Added OJ citation: "Regulation (EU) 2024/1183 in April 2024". -->
<!-- P2 item: [ch01-three-converging-forces] (A) — Ethereum TPS: "roughly 15" → "roughly 12–15". -->
<!-- P2 item: [ch01-three-converging-forces] (C) — Replaced the three bolded listicle headers with running prose transitions ("The first is a privacy crisis that became quantifiable.", "The second force is a scaling problem that acquired a price tag.", "The third force is a cost curve that collapsed."), integrating eIDAS paragraph under the first force and Ethereum/rollup content under the second. -->
<!-- P2 item: [ch01-the-deepest-question] (A) — "$2^{64}$ elements" now labeled as "the 64-bit Goldilocks field ($2^{64} - 2^{32} + 1$)" with note that count is field-specific. -->
<!-- P2 item: [ch01-the-deepest-question] (C) — Removed "I'm not entirely sure the seven-layer framing does justice to what happens next" hedge; replaced with direct entry: "Layers 4 and 5 are where the abstract becomes visceral." -->
<!-- P2 item: [ch01-the-deepest-question] (C) — "There is a symmetry worth noting" → "There is a symmetry to notice." (already present in source; verified fixed). -->
<!-- P2 item: [ch01-the-seven-layers-at-a-glance] (A) — Layer 3 description: "leaked information about transaction amounts" → "correlated with transaction amounts -- allowing statistical inference of values the mathematics had promised to hide." -->
<!-- P2 item: [ch01-the-seven-layers-at-a-glance] (C) — Three-act structural description collapsed from standalone paragraph into a single transitional sentence: "The first three layers are about preparation ... The next two transform that preparation ... The final two supply the cryptographic bedrock and the real-world stage ..." -->
<!-- P2 item: [ch01-the-seven-layers-at-a-glance] (E) — Layer 6 description now names the three hardness assumption classes: discrete logarithm problem, hash collision resistance, and lattice problems (post-quantum replacements). -->
<!-- P2 item: [ch01-the-first-decision] (B) — Added citation for Zcash Sprout ceremony: "[Zcash Foundation, 'The Design of the Ceremony,' 2016]" and for KZG Summoning: "[Ethereum Foundation, 'Wrapping up the KZG Ceremony,' January 2024]". -->
<!-- P2 item: [ch01-the-first-decision] (C) — Cell count verified: top row 2, row 2 two, row 3 one, row 4 two = 7 given cells. Changed "Eight cells are given; eight are blank" → "Seven cells are given; nine are blank". -->
<!-- P2 item: [ch01-how-to-read-this-guide] (C) — Replaced three bold-header reading-path outline with flowing prose paragraphs for each path. -->
<!-- P2 item: [ch01-how-to-read-this-guide] (D) — Added Chapter 14 descriptor: "which catalogs seven open research questions and the system-level tradeoffs that frame each one." -->
<!-- P2 item: [ch01-how-to-read-this-guide] (E) — Three frontiers now explicitly linked back to chapter evidence: "the three forces described in this chapter map onto them directly" with specific citations (cost collapse from $80 to $0.04, SP1 Hypercube, Stwo). -->
