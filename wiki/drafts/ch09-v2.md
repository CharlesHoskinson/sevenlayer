...
Resolved findings (6 P1, 0 P0):

1. **ch09-open-problems** (P1-B): Added full inline citation for Ozdemir and Boneh, "Experimenting with Collaborative zk-SNARKs: Zero-Knowledge Proofs for Distributed Secrets," USENIX Security 2022 (ePrint 2021/1530). Verified ePrint ID 2021/1530 via USENIX and IACR ePrint archive.

2. **ch09-privacy-architectures-for-smart-contracts-kachina-and-zexe** (P1-B): Standardized Zexe citation to "Bowe, Chiesa, Green, Miers, Mishra, and Wu (IEEE S&P 2020, preprint 2018; ePrint 2018/962)" at first mention in the Zexe section, and repeated the shorter form "Bowe et al., IEEE S&P 2020, preprint 2018; ePrint 2018/962" at the subsequent curve-discussion paragraph and at the Aztec paragraph.

3. **ch09-privacy-architectures-for-smart-contracts-kachina-and-zexe** (P1-A): Replaced the ambiguous "BLS-12 curve" with "BLS12-377 -- a pairing-friendly curve chosen so that its scalar field matches the base field of the outer curve BW6-761 (a Cocks-Pinch construction) for recursive composition," preserving the Cocks-Pinch reference already present in the original.

4. **ch09-the-four-pillars** (P1-B): Updated the Gentry FHE citation to "Gentry, 'Fully Homomorphic Encryption Using Ideal Lattices,' STOC 2009; see also Gentry's PhD thesis, Stanford 2009, for the expanded treatment," matching bibliography ref #29.

5. **ch09-three-kinds-of-security** (P1-A): Unified currency for Battering RAM at "approximately €50" in body text. Added attribution: "De Meulemeester, Oswald, Verbauwhede, and Van Bulck; KU Leuven, Birmingham, and Durham, disclosed September 2025." Verified author list via search (Kaspersky, Dark Reading, and Cyberpress sources). Wiretap kept at "~$1,000" since that is the figure the Wiretap authors themselves report; attribution softened to "disclosed simultaneously in the US" because web search did not return a confirmed author list.

6. **ch09-three-kinds-of-security** (P1-B): Added inline citations at each first mention of dated TEE attacks: Foreshadow (Van Bulck et al., USENIX Security 2018); AEPIC Leak (Borrello et al., USENIX Security 2022); Downfall (Moghimi, 2023; Intel advisory INTEL-SA-00828, CVE-2022-40982); SGAxe (Van Schaik et al., 2020); Plundervolt (Murdock et al., IEEE S&P 2020); SGX deprecation ("11th/12th generation client chips in 2021"). Each dated attack paragraph also carries a repeated parenthetical with the citation for reader convenience.

Verification notes:
- USENIX and IACR ePrint confirm Ozdemir-Boneh 2021/1530.
- Kaspersky, Dark Reading, Cyberpress, and The Hacker News confirm Battering RAM authors De Meulemeester, Oswald, Verbauwhede, and Van Bulck (KU Leuven, Birmingham, Durham), September 2025, cost €50.
- Wiretap authors could not be confirmed via 1 search; softened to "disclosed simultaneously in the US" without author names; cost retained at ~$1,000 as reported by The Hacker News and Kaspersky.
- Length: revised draft is approximately 7,650 words vs approximately 7,400 words in the source (within +4%, well under the ±15% bound).
