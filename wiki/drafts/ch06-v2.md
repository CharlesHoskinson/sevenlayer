...
P1-1 (ch06-fiat-shamir-vulnerabilities, B): Added citations for all three incidents.
  - Frozen Heart: Trail of Bits, April 2022, blog.trailofbits.com/2022/04/13/... [ref 22]. Wording preserved from original with explicit date added.
  - Last Challenge Attack: gnark advisory GHSA-7p92-x423-vwj6, October 2023 (not 2024 as original stated — corrected). Cited inline.
  - Solana ZK ElGamal: Two separate 2025 incidents confirmed from primary postmortems (solana.com/news/post-mortem-may-2-2025, solana.com/news/post-mortem-june-25-2025). Text expanded from one vague mention to specific descriptions of both vulnerabilities. Date changed from "early 2025" to "2025" covering both incidents.

P1-2 (ch06-nightstream Lean boundary, D): Near-verbatim repetition in two paragraphs merged. Original had two consecutive passages making the same point about the Lean/Rust gap (one ending "Mathematics proven correct in the abstract..." and another beginning "To be concrete about what Lean proves..."). Merged into a single coherent passage that covers both the affirmative (what Lean proves) and the negative (what it does not prove) without restating.

P1-3 (ch06-recursion-vs-folding, A): Zexe citation corrected throughout. Original said "Bowe, Chiesa, Green, Miers, Mishra, Wu, 2018" without venue. Changed to "Bowe, Chiesa, Green, Miers, Mishra, and Wu (IEEE S&P 2020, preprint 2018; ePrint 2018/962)" per instruction.

P1-4 (ch06-the-folding-genealogy, A): LatticeFold venue confirmed as ASIACRYPT 2025. Web search confirmed Springer proceedings URL (978-981-95-5099-9, consistent with ASIACRYPT 2025). Bibliography entry #20 is correct. Section heading and body text updated to use "Boneh and Chen (ePrint 2024/257), published at ASIACRYPT 2025" for clarity. LatticeFold+ (CRYPTO 2025; ePrint 2025/247) noted in same paragraph for disambiguation.

P1-5 (ch06-the-folding-genealogy, B): ProtoGalaxy authors confirmed as only two: Liam Eagen and Ariel Gabizon (ePrint 2023/1106). DBLP and ePrint both list two authors. No third author. Citation changed from "Eagen and Gabizon" (bare) to "Eagen and Gabizon, ePrint 2023/1106" for traceability.

P1-6 (ch06-the-hybrid-pipeline, B): Concrete timing/cost figures now sourced.
  - "3 to 5 seconds" STARK proving time: SP1 Hypercube blog [52] cited.
  - "5 to 10 seconds" Groth16 wrapping: SP1 Hypercube blog [52] cited.
  - "$0.50 to $1.00" on-chain verification: Ethproofs [44] cited for live cost figures.
  - Broader cost/performance claims (CastleLabs, Ethproofs) in Real-Time Ethereum section already cited [43, 44].
-->
