...
| # | Finding ID | Status | Change |
|---|---|---|---|
| P3-1 | ch07-algebraic-vs-traditional-hash-functions (C) | RESOLVED | "discussed in Chapter 4" replaced with wiki-link `[[ch04-side-channel-attacks-when-the-walls-leak]]` |
| P3-2 | ch07-case-study-midnight (D) | RESOLVED | Added version note above Neo comparison table: figures reflect 2025 paper parameterization; Nightstream Rust implementation may diverge |
| P3-3 | ch07-four-families-of-commitment-schemes (D) | RESOLVED | Added reader-navigation note flagging FRI and IPA sub-sections as depth-focused |
| P3-4 | ch07-lattice-based-proving (E) | RESOLVED | Added ballpark size/verification numbers for LatticeFold (200--400 KB baseline) and LatticeFold+ (100--200 KB, constant ring-multiplication verifier) |
| P3-5 | ch07-maturity-and-readiness (E) | RESOLVED | Added formal verification of lattice folding reductions (unverified paper proofs) as an explicit deployment blocker |
| P3-6 | ch07-small-fields (E) | RESOLVED | Added explanation of why BabyBear requires degree-4 extension: $p-1 = 2^{27} \cdot 15$ means $\mathbb{F}_{p^2}$ yields only ~62-bit security; named concrete irreducible $X^4+7$ |
| P3-7 | ch07-the-cascade-effect (C) | RESOLVED | Removed redundant closing "branching tunnels" sentence that echoed the one-way-door metaphor three paragraphs earlier |
| P3-8 | ch07-the-laws-that-break (C) | RESOLVED | Trimmed Feynman rhetorical question preamble; removed AI-essay framing, tightened to direct statement |
| P3-9 | ch07-the-one-way-door (C) | RESOLVED | "secrets written in ink that merely required a light that had not yet been invented" simplified to "waiting for a reader with the right equipment" |
| P3-10 | ch07-the-quantum-threat-horizon (C) | RESOLVED | Option 3 heading changed from "Ignore / Hope that..." to "Defer / Assume..." -- removes editorializing tone |
| P3-11 | ch07-the-structural-advantage-of-lattices (E) | RESOLVED | Added concrete quantification: Halo2 dual-curve parameter overhead; non-native arithmetic 10--30x per operation; Neo uses one ring, no non-native arithmetic |
| P3-12 | ch07-the-trilemma-and-its-dissolution (C) | RESOLVED | Collapsed question-answer-elaboration-conclusion structure into one tighter paragraph |
| P3-13 | ch07-three-hardness-assumptions-three-worlds (C) | RESOLVED | Replaced double nested parentheticals explaining Pedersen with [[pedersen]] wiki-link |
