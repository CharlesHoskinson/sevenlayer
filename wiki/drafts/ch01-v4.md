...
<!-- Revision ledger -->
- [ch01-the-trick] Added parenthetical hint listing seven layer names when mentioning "seven independent, weaker assumptions" to ground the claim
- [ch01-the-phenomenon] Added sentence explaining STARK proof size variance scales with log of computation depth
- [ch01-the-phenomenon] Added mention of FRI-based systems (STARKs) as canonical transparent approach
- [ch01-the-seven-layers-at-a-glance] Added one-sentence hint previewing fourteen causal edges in Chapter 10 DAG
- [ch01-the-deepest-question] Added concrete hardware cost data point (4 GB RAM, 10+ seconds) for client-side proving asymmetry
- [ch01-three-converging-forces] Consolidated flywheel and Midnight disclosure paragraphs to reduce duplication while maintaining full context
