...
---
<!-- Revision ledger -->
- ch05-ccs-the-rosetta-stone [ProtoStar/ProtoGalaxy depth]: applied -- added one-line characterization of each scheme's mechanism in Why CCS Matters Now
- ch05-ccs-the-rosetta-stone [R1CS repetition tighten]: applied -- trimmed redundant R1CS derivation sentence in Three Dialects, One Grammar
- ch05-layer-4-arithmetization [five-act ordering inconsistency]: applied -- added clarifying sentence after five-act list fixing sumcheck=act three, lookups=act four
- ch05-layer-4-arithmetization [forward ref R-L4-1 for GGPR]: applied -- [R-L4-1] inline citation added at R1CS section opening
- ch05-lookup-arguments [Jolt recursion/deployment gap]: applied -- expanded Jolt alpha note: named missing recursion and on-chain verification implication
- ch05-midnight-s-zkir-a-concrete-layer-4 [no end-to-end ZKIR count]: skipped -- precise token-transfer node count requires compiler run data not available; ~200-300 node estimate for verify_sudoku retained as proxy
- ch05-the-constraint-system-evolution-r1cs-air-plonkish [Halo2 IPA/trusted setup]: applied -- added note on IPA vs KZG and Halo2's no-trusted-setup property in PLONKish section
- ch05-the-overhead-tax-10-000x-to-50-000x [USD proving cost]: applied -- added paragraph on approximate dollar cost per Ethereum block proof on GPU clusters
- ch05-the-spreadsheet-metaphor-and-where-it-works [Schwartz/Zippel citations]: applied -- added [R-SZ-1] and [R-SZ-2] at first Schwartz-Zippel appearance; full entries in Sources
- ch05-the-sumcheck-protocol-the-hidden-foundation [JCSS volume/pages]: applied -- updated Reference Data and [R-L4-SC] Sources entry to Vol. 44, No. 2, 1992, pp. 282-296
- ch05-where-the-analogies-break [Reference Data placement]: skipped -- moving to chapter hub requires restructuring outside this file; flagged for hub editor
- ch05-where-the-layers-collapse [Cairo write-once numeric depth]: applied -- added quantitative sorted-access vs Merkle cost comparison (~10x-50x cheaper) in Cairo Co-Design subsection
- ch05-where-the-layers-collapse [Cairo citation missing]: applied -- added [R-L4-Cairo] Goldberg et al. 2021 inline and in Sources
