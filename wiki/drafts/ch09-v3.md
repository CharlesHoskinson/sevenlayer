...
## v2 resolved findings (carried forward, 6 P1 items)

1. **ch09-open-problems** (P1-B): Added full inline citation for Ozdemir and Boneh, USENIX Security 2022 (ePrint 2021/1530).
2. **ch09-kachina-zexe** (P1-B): Standardized Zexe citation to Bowe et al., IEEE S&P 2020, ePrint 2018/962.
3. **ch09-kachina-zexe** (P1-A): Replaced ambiguous "BLS-12 curve" with BLS12-377 / BW6-761 (Cocks-Pinch) for recursive composition.
4. **ch09-four-pillars** (P1-B): Updated Gentry citation to STOC 2009 + Stanford PhD thesis 2009.
5. **ch09-three-kinds-of-security** (P1-A): Unified Battering RAM cost at €50 with full author list; Wiretap at ~$1,000.
6. **ch09-three-kinds-of-security** (P1-B): Added inline citations at each first mention of dated TEE attacks (Foreshadow, AEPIC Leak, Downfall, SGAxe, Plundervolt).

## v3 resolved findings (11 P2 items)

1. **ch09-composability** (B) — *MPC-to-FHE citation*: Added reference to Boura et al., Journal of Mathematical Cryptology 2020, and CRYPTO 2023 share-to-ciphertext work in the handoff discussion. **Resolved.**

2. **ch09-composability** (E) — *Privacy stack ordering needs citation*: Added references to Dwork and Roth (Foundations and Trends 2014) for the DP tier and Goldreich (Foundations of Cryptography, Vol. 2, 2004) for MPC/FHE tiers in the Privacy Stack subsection. **Resolved.**

3. **ch09-open-problems** (B) — *EUROCRYPT 2026 PIR claim unverifiable*: Flagged as provisional ("if confirmed… treat these benchmarks as provisional pending peer review"). **Resolved.**

4. **ch09-kachina-zexe** (B) — *Duplicate wiki slug ch03/ch04*: Metadata issue only; prose correctly references "Chapter 3" in both v2 and v3. **Already resolved in v2 / wiki metadata outside prose scope.**

5. **ch09-real-world-deployments** (A) — *`[[nova]]` entity tag*: Metadata tagging issue; no prose change required. **Outside prose scope.**

6. **ch09-decision-matrix** (A) — *TEE "<5% overhead" conflicts with Downfall "50%" degradation*: Added explicit caveat in both the trust-model bullet and the performance bullet, citing Moghimi 2023. **Resolved.**

7. **ch09-decision-matrix** (B) — *No sources cited in decision matrix*: Added introductory sentence directing readers to prior-section citations; added Moghimi 2023 inline for the specific TEE figure. **Resolved.**

8. **ch09-four-pillars** (B) — *Yao (1982), Dwork/Rothblum/Vadhan (2010), Dinur/Nissim (2003) absent from bibliography*: Added inline parenthetical citations at first mention of each: Yao FOCS 1982, Dinur-Nissim PODS 2003, Dwork-Rothblum-Vadhan FOCS 2010. **Resolved.**

9. **ch09-four-pillars** (C) — *"key insight" AI-smell phrase*: Phrase does not appear in v2 or the source; already absent. **Already resolved / not present.**

10. **ch09-regulatory-intersection** (A) — *eIDAS 2.0 "effective from 2024" misleading*: Rewritten to "entered into force in 2024; member states are required to offer citizens a European Digital Identity Wallet by 2026." **Resolved.**

11. **ch09-three-kinds-of-security** (D) — *TEE deprecation section does not reconnect to heuristic-security taxonomy*: Added closing sentence before the lock metaphor: "This is the practical meaning of the heuristic-security tier: not worthless, but fragile in ways that information-theoretic and computational guarantees are not." **Resolved.**
