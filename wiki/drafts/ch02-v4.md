...
<!-- Revision ledger -->
<!-- v4 — 12 P3 fixes applied (2026-04-18)
  ch02-the-fair-shuffle-problem: clarified hybrid pattern predates 2026; StarkWare used it from 2021
  ch02-the-structured-reference-string: added forward reference to curve discussion for 65M-point count
  ch02-two-ways-to-build-a-stage: added forward reference to CVE-2019-7167 at BCTV14 mention
  ch02-the-capex-opex-framework: added cross-reference to ch05 SP1/Stwo benchmarks
  ch02-the-141-416-person-question: added Nikolaenko et al. formal security model reference
  ch02-the-quantum-shelf-life: clarified Grover applies to pre-image search; BHT gives 2^(n/3) for collisions; qRAM caveat retained
  ch02-the-adopt-framework: applied ADOPT retroactively to Sprout and Sapling with explicit scores
  ch02-universal-versus-circuit-specific-setups: added Sonic (Maller et al., 2019) as first universal SNARK
  ch02-bn254-s-eroding-security-margin: added EIP-2537 note on BLS12-381 precompiles addressing migration barrier
  ch02-midnight-s-bls12-381-stage: noted ceremony status (in progress, not yet finalized); added ADOPT comparison to Ethereum KZG
  ch02-option-value-analysis: added note on hybrid inner/outer distinction and partial option already exercised
  ch02-the-setup-tradeoff: added on-chain ceremony verification (Nikolaenko et al.) as emerging third path
-->
