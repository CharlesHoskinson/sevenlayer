...
- [P0] (A) Lesson 3 states "fees are paid in a shielded token generated by time-locked staking." DUST is explicitly unshielded (public) per ch12-midnight-at-a-glance and ch08. "Shielded token" here is factually wrong; should read "public (unshielded) token" or "fee token."
